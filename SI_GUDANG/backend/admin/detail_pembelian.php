...
if(isset($_POST['submit'])){
    ...
    // Insert detail
    mysqli_query($conn, "INSERT INTO detail_pembelian 
    ...
    mysqli_query($conn, "UPDATE tb_pembelian SET 
...
if(isset($_GET['hapus_item'])){
    ...
    // Hapus detail
    mysqli_query($conn, "DELETE FROM detail_pembelian WHERE no_pembelian='$no_pembelian' AND no_item=$no_item");
