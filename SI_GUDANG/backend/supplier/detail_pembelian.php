...
$header = mysqli_fetch_assoc(mysqli_query($koneksi,
    "SELECT tp.*, ts.nama_supplier FROM tb_pembelian tp
     LEFT JOIN tb_supplier ts ON tp.id_supplier = ts.id_supplier
     WHERE tp.no_pembelian='$no_pembelian'"));

// Validasi: pastikan transaksi ini milik supplier yang login
...
if(!$cek_supplier || $header['id_supplier'] != $cek_supplier['id_supplier']){
    echo "<script>alert('Anda tidak memiliki akses ke transaksi ini!');window.location='transaksi_pembelian.php';</script>";
    exit;
}
?>
<!DOCTYPE html>
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <h4 class="card-title mb-0">Detail Transaksi Pembelian</h4>
                  ...
                  <div class="col-md-6">
                    <table class="table table-borderless">
                      <tr>
                        ...
                        <td>: <?php echo $header['no_pembelian']; ?></td>
                      </tr>
                      <tr>
                        <td class="font-weight-bold">Tanggal</td>
                        <td>: <?php echo date('d-m-Y', strtotime($header['tanggal_pembelian'])); ?></td>
                      </tr>
                      <tr>
